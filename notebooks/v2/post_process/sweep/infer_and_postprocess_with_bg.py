"""
Usage:
python infer_and_postprocess.py input_image.jpg background_image.jpg --model1_ckpt path/to/custom_model1_checkpoint.pth --model2_ckpt path/to/custom_model2_checkpoint.pth --output_path path/to/output_image.png

or

python infer_and_postprocess.py input_image.jpg background_image.jpg
...
bg_image_path = '/home/shravan/documents/deeplearning/datasets/segmentations_samples/backgrounds/Subrata/img_acp_background_4323.jpg'
...
Example: 
python infer_and_postprocess.py /home/shravan/documents/deeplearning/github/alpha_matte_segmentation/notebooks/v2/Review_Dir/FootRest/Original/2a5e854530b04c8f86d1c622ab64f608.jpg /home/shravan/documents/deeplearning/datasets/segmentations_samples/backgrounds/Subrata/img_acp_background_4323.jpg
"""

import os
import sys
sys.path.append("/home/shravan/documents/deeplearning/github/alpha_matte_segmentation")
...
def main(args):
    ...
    image_alpha, glass_image = infer_and_post_process(
        args.input_image_path, model1, model2, device, bg_image_path=None, save_dir="results", inhouse_dir=None
    )
    ...
    composite_image = add_background(merged_image, args.bg_image_path)
    
    cv2.imwrite(args.output_path, np.array(composite_image))

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Image Processing and Segmentation")
    parser.add_argument("input_image_path", type=str, help="Path to the input image")
    parser.add_argument("bg_image_path", type=str, help="Path to the background image")
    parser.add_argument("--model1_ckpt", type=str, default="/home/shravan/documents/deeplearning/github/segmentation_models/checkpoints/20230823/model_20230823_133015/last.ckpt", help="Path to the model1 checkpoint")
    parser.add_argument("--model2_ckpt", type=str, default="/home/shravan/documents/deeplearning/github/alpha_matte_segmentation/trimap_generation/checkpoints/20240102/model_20240102_155705/last.ckpt", help="Path to the model2 checkpoint")
    parser.add_argument("--output_path", type=str, default="out.png", help="Path to save the output image")
